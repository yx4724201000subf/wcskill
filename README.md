...
| `/wc-hook-dy`   | 抖音对标开头引擎。拆对标账号表格 → 提炼 0-2s 开头范式库 → 为你的正文产出 5-10 个 0-2s 备选开头 |
...
- **阶段2｜套用**：喂自己的正文，从范式库匹配 5-10 个 0-2s 备选开头，至少覆盖"标签组合型 + 小半句型"两种起手类型；只出 0-2s，好奇区间和引子留给用户自己处理
